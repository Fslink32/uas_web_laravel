...
!(function(e, t) {
  ...
  const i = (e => {
      ...
      return (e.fn.mmEmulateTransitionEnd = i), (e.event.special[
        n.TRANSITION_END
      ] = {
        bindType: t,
        delegateType: t,
  ...
  class c {
      ...
      i.addClass(
        ...
        r.hasClass(g)
          ...
          : (
              ...
              e.setActive(r),
              t.toggle && (e.removeActive(a), o.attr("aria-expanded", "false"))
    ...
    hide(e) {
      ...
      t
        ...
        .removeClass(
          g
        ), t.height(t.height())[0].offsetHeight, t.addClass(f).removeClass(u).removeClass(h), this.setTransitioning(!0);
      const r = () => {
        this.config &&
          this.element &&
          (
    ...
    dispose() {
      n.default.removeData(
        this.element,
        r
      ), n.default(this.element).find(this.config.parentTrigger).children(this.config.triggerElement).off(l.CLICK_DATA_API), (this.transitioning = null), (this.config = null), (this.element = null);
    }
  ...
  return (n.default.fn[s] =
    c.jQueryInterface), (n.default.fn[s].Constructor = c), (n.default.fn[s].noConflict = () => ((n.default.fn[s] = a), c.jQueryInterface)), c;
});
