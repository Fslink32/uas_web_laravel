...
FullCalendar.RRule = (function(e, r, t, i) {
  ...
  const u = {
              ...
              let r = l.rrulestr(e, { forceset: !0 }),
                t = (function(e) {
                  ...
                  function n(e, n, l) {
                    ...
                    (r = r || !u.isTimeUnspecified), (t =
                      t || null !== u.timeZoneOffset);
                  }
                  return e.replace(/\b(DTSTART:)([^\n]*)/, n), e.replace(
                    ...
                    isTimeSpecified: r,
                    isTimeZoneSpecified: t
                  };
                })(e);
              return Object.assign({ rruleSet: r }, t);
            })(e.rrule);
            (t = r.rruleSet), (n = r.isTimeSpecified), (u =
              r.isTimeZoneSpecified);
          }
          if ("object" == typeof e.rrule && e.rrule) {
            let i = a(e.rrule, r);
            (t = new l.RRuleSet()), t.rrule(i.rrule), (n =
              i.isTimeSpecified), (u = i.isTimeZoneSpecified);
          }
          let f = [].concat(e.exdate || []),
            s = [].concat(e.exrule || []);
          for (let e of f) {
            let r = i.parseMarker(e);
            (n = n || !r.isTimeUnspecified), (u =
              u || null !== r.timeZoneOffset), t.exdate(
              new Date(r.marker.valueOf() - 60 * (r.timeZoneOffset || 0) * 1e3)
            );
          }
          for (let e of s) {
            let i = a(e, r);
            (n = n || i.isTimeSpecified), (u =
              u || i.isTimeZoneSpecified), t.exrule(i.rrule);
          }
    ...
    expand(e, r, t) {
      let i;
      return (i = e.isTimeZoneSpecified
        ? e.rruleSet
            .between(t.toDate(r.start), t.toDate(r.end), !0)
            .map(e => t.createMarker(e))
        : e.rruleSet.between(r.start, r.end, !0)), i;
    }
  };
  function a(e, r) {
    let t = !1,
