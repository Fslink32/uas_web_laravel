    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                <div>Tambah <?php echo $page_description; ?> Baru</div>
            </div>
        </div>
    </div>
    <div class="d-block">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <form class="card mb-3" id="form-create" method="POST" action="{{ route('admin.role.store') }}"
                    enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="card-header-tab card-header">
                        <div class="card-header-title font-size-lg text-capitalize font-weight-normal">Formulir Jabatan Baru
                        </div>
